...
public class Banner: UIView {
    ...
    public var springiness = BannerSpringiness.None
    ...
    public var dismissesOnImageViewClicked = true
    ...
    public let titleLabel: UILabel = {
        ...
        label.font = UIFont(latoBoldWithSize: 12)
    ...
    public required init(title: String? = nil, didTapBlock: (() -> ())? = nil) {
        
        let image = UIImage(named: "view-dismiss")
        let backgroundColor = UIColor.otuzOrange()
    ...
    internal func didTapImageView(recognizer: UITapGestureRecognizer) {
        if dismissesOnImageViewClicked {
            dismiss()
        }
    ...
    private func initializeSubviews() {
        ...
        var constraintFormat = "H:|-(15)-[labelView]-(15)-|"
        ...
        if image != nil{
            ...
            constraintFormat = "H:[imageView]-(15)-[labelView]-(40)-|"
        }
        
        //leftConstraintText = "|" //added
        ...
        let gest = UITapGestureRecognizer(target: self, action: "didTapImageView:")
    ...
    private func adjustHeightOffset() {
        ...
        if superview === Banner.topWindow() {
            ...
            minimumHeightConstraint.constant = statusBarSize.height > 0 ? 80 : 56 // changed, 40
        } else {
